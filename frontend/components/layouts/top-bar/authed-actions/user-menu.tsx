		...
		<DropdownMenu.Root>
			...
			<DropdownMenu.Portal>
				<DropdownMenu.Content
					...
					<DropdownMenu.Item className="outline-none border-l-2 border-transparent hover:border-red-600 w-full flex gap-3 px-4 py-3 items-center text-lg text-red-600 cursor-pointer">
						<LogOut size={24} />
						<span>Sign out</span>
					</DropdownMenu.Item>
				</DropdownMenu.Content>
